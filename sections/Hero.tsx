    ...
    return (
        ...
        style={{
            ...
            <div className="container relative px-4 ">
                ...
                <form className="flex  border justify-between border-white/15 rounded-full p-2  max-w-lg  mt-8 md:mx-auto ">
                    <input type="email" placeholder="Enter you email" className="bg-transparent  pl-4  md:flex-1" />
                    <Button size="sm" type="submit" className=" flex  whitespace-nowrap justify-center items-center" variant='primary'>Sign Up</Button>
                </form>
            </div>
